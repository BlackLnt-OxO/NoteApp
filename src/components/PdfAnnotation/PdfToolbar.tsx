/**
 * PdfToolbar — tool + brush panel for the PDF annotation view.
 *
 * Same UX as the infinite-canvas toolbar (expandable tools with a small
 * triangle, SVG icons only, no emoji), but bound to the PdfStore.  Mounted
    ...
    <div style={{ padding: '10px 14px 12px', color: 'var(--text-primary)', touchAction: 'none' }}
      ...
      <button
        ...
        style={{
          ...
          color: 'var(--danger, #e74c3c)', cursor: 'pointer', fontSize: fs(11, gfs), fontFamily: 'inherit',
